...
% noiseFreeExcitationNull_same = [zeros(1,1,3822), noiseFreeExcitationNull_same];
% noiseFreeExcitationTest_same = [zeros(1,1,3822), noiseFreeExcitationTest_same];
% noisyExcitationNull_same = [zeros(nTrialsNum,1,3822), noisyExcitationNull_same];
% noisyExcitationTest_same = [zeros(nTrialsNum,1,3822), noisyExcitationTest_same];
% timeAxis8frames = [0, timeAxis8frames];
...
hold off
%% Visualizing Photocurrent
visualizeConeExcitation(noiseFreePhotocurrStimulus_c1_f1, noisyPhotocurrStimulus_c1_f1, [0.01 0.02 0.03 0.04]);
